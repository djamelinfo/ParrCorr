...
public class Receiver extends org.apache.spark.streaming.receiver.Receiver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaReceiverInputDStream<String> lines = ssc.receiverStream(
                new Receiver(args[0], Integer.parseInt(args[1])));
    ...
    public Receiver(String host_ , int port_) {
