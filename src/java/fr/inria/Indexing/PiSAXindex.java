...
/*
    ...
    public void ExactSearch(JavaPairRDD<Integer, float[]> QuerytimeSeries, JavaSparkContext sc  ) {
        ...
        JavaPairRDD<Integer, ArrayList<Integer>> q1 = this.ApproximateSearch(QuerytimeSeries, sc);


      //  this.finalRDD.mapPartitionsToPair(new PairFlatMapFunction<Iterator<Tuple2<Integer,AbstractNode>>
      //          , >() {
      //  });
